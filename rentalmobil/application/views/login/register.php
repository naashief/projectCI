...
<head>
  ...
  <title>Rental Mobil - Registrasi</title>
...
<div class="card-header text-center">
      <a href="#" class="h1"><img style="width: 55px;" src="<?=base_url('assets/img/carr.png')?>" alt=""> <b>Rental</b>Mobil</a>
    </div>
  <!-- /.login-logo -->
  <div class="card">
    ...
    <?php } ?>
     <?php echo form_open('login/prosesRegister',['action'=>'POST']);?>
        ...
        <div class="input-group mb-2">
            <button type="submit" class="form-control btn btn-primary btn-block">REGISTRASI</button>
        </div>
    <?php echo form_close(); ?>

      <p class="mb-1 text-center mt-2"> Sudah memiliki akun?
        <a href="<?= base_url();?>index.php/login/login">Sign In</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
